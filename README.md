...
**SoulMate** is a lightweight and intuitive addon for Warlocks that automatically manages Soul Shards, removes excess shards, and provides a customizable on‑screen button for manual cleanup.  
...
- WoW Classic  
- WoW TBC Classic  
- WoW WotLK Classic (if Interface version is updated)  
